...
from fake_stake.base_test import MNPosTree_FakeStakeTest

class zMPTCwrappedSerialsTest(MNPosTree_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zMPTCs..." % DENOM_TO_USE)
