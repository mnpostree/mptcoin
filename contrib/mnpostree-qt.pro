...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/mnpostree-cli.cpp \
           src/mnpostree-tx.cpp \
           src/mnpostree.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/mnpostree.qrc src/qt/mnpostree_locale.qrc

TRANSLATIONS += src/qt/locale/mnpostree_bg.ts \
                src/qt/locale/mnpostree_de.ts \
                src/qt/locale/mnpostree_en.ts \
                src/qt/locale/mnpostree_es.ts \
                src/qt/locale/mnpostree_fi.ts \
                src/qt/locale/mnpostree_fr.ts \
                src/qt/locale/mnpostree_it.ts \
                src/qt/locale/mnpostree_ja.ts \
                src/qt/locale/mnpostree_pl.ts \
                src/qt/locale/mnpostree_pt.ts \
                src/qt/locale/mnpostree_ru.ts \
                src/qt/locale/mnpostree_sk.ts \
                src/qt/locale/mnpostree_sv.ts \
                src/qt/locale/mnpostree_vi.ts \
                src/qt/locale/mnpostree_zh_CN.ts \
                src/qt/locale/mnpostree_zh_TW.ts
