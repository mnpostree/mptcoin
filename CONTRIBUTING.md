Contributing to MNPosTree Core
============================

The MNPosTree Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mnpostree-project/mnpostree/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MNPosTree Core project, and is not to be
confused with overall MNPosTree Network Protocol consensus changes.

Whether a pull request is merged into MNPosTree Core rests with the project merge
...
Patches that change MNPosTree consensus rules are considerably more involved than
...
Where a patchset proposes to change the MNPosTree consensus, it must have been
...
The project leader is the release manager for each MNPosTree Core release.
