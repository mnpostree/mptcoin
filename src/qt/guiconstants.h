...
/* MNPosTree GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MNPosTree"
#define QAPP_ORG_DOMAIN "mnpostree.org"
#define QAPP_APP_NAME_DEFAULT "MNPosTree-Qt"
#define QAPP_APP_NAME_TESTNET "MNPosTree-Qt-testnet"
