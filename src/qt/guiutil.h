...
/** Utility functions used by the MNPosTree Qt UI.
 */
namespace GUIUtil
{
...
// Render MNPosTree addresses in monospace font
...
// Parse "mnpostree:" URI into recipient object, return true on successful parsing
