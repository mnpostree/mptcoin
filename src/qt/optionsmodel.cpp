...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::MPTC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeMNPosTreeAmount"))
        SoftSetArg("-anonymizemnpostreeamount", settings.value("nAnonymizeMNPosTreeAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in mnpostree.cpp during shotdown to also remove the window positions
