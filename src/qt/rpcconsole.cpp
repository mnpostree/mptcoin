                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMPTCPathCustom = GetArg("-zmptcbackuppath", "");
    ...
    if(!strzMPTCPathCustom.empty()) {
        ui->wallet_customzmptcbackuppath->setText(QString::fromStdString(strzMPTCPathCustom));
        ui->wallet_customzmptcbackuppath_label->setVisible(true);
        ui->wallet_customzmptcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMPTCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MNPosTree RPC console.") + "<br>" +
