...
#ifndef MNPosTree_ZMPTCTRACKER_H
#define MNPosTree_ZMPTCTRACKER_H
...
public:
    CzMPTCTracker(std::string strWalletFile);
    ~CzMPTCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMPTCWallet* zMPTCWallet = NULL);
...
#endif //MNPosTree_ZMPTCTRACKER_H
