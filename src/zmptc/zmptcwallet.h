...
#ifndef MNPosTree_ZMPTCWALLET_H
#define MNPosTree_ZMPTCWALLET_H
...
public:
    CzMPTCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMPTC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMPTC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
