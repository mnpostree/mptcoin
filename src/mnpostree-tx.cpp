...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MNPosTree Core mnpostree-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnpostree-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnpostree transaction") + "\n" +
                               "  mnpostree-tx [options] -create [commands]   " + _("Create hex-encoded mnpostree transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnpostree transaction
