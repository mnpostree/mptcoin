...
public:
    CMainParams()
    {
         ...
         *     CTxOut(nValue=1.00000000, scriptPubKey=0xA9037BAC7050C479B121CF)
         *   vMerkleTree: e0028e
         */
        ...
        vSeeds.push_back(CDNSSeedData("mnpostree.com", "seed1.mnpostree.com"));
        vSeeds.push_back(CDNSSeedData("n2.mnpostree.com", "seed2.mnpostree.com"));
