/* src/config/mnpostree-config.h.  Generated from mnpostree-config.h.in by configure.  */
/* src/config/mnpostree-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.mnpostree.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MNPosTree Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MNPosTree Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mnpostree"
