...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MNPosTree server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MNPosTree server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MNPosTree features */
        {"mnpostree", "listmasternodes", &listmasternodes, true, true, false},
        {"mnpostree", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mnpostree", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mnpostree", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mnpostree", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mnpostree", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mnpostree", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mnpostree", "masternodedebug", &masternodedebug, true, true, false},
        {"mnpostree", "startmasternode", &startmasternode, true, true, false},
        {"mnpostree", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mnpostree", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mnpostree", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mnpostree", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mnpostree", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mnpostree", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mnpostree", "preparebudget", &preparebudget, true, true, false},
        {"mnpostree", "submitbudget", &submitbudget, true, true, false},
        {"mnpostree", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mnpostree", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mnpostree", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mnpostree", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mnpostree", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mnpostree", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mnpostree", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mnpostree", "checkbudgets", &checkbudgets, true, true, false},
        {"mnpostree", "mnsync", &mnsync, true, true, false},
        {"mnpostree", "spork", &spork, true, true, false},
        {"mnpostree", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmptcseed", &getzmptcseed, false, false, true},
        {"zerocoin", "setzmptcseed", &setzmptcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmptc", &searchdzmptc, false, false, true},
        {"zerocoin", "dzmptcstate", &dzmptcstate, false, false, true},
...
{
    return "> mnpostree-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26817/\n";
}
