...
/**
 * MNPosTree RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZmptcSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzmptcseed(const UniValue& params, bool fHelp);
extern UniValue getzmptcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmptc(const UniValue& params, bool fHelp);
extern UniValue dzmptcstate(const UniValue& params, bool fHelp);
